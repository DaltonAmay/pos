                                    ...
                                    <div class="card-body">
                                        ...
                                        <form class="validar_tipo_doc_new" novalidate id="form_Tipo_Documento">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    <label class="mb-0 ml-1 text-sm my-text-color"><i class="fas fa-layer-group mr-1 my-text-color"></i>Tipo de Documento</label>
                                                    <input type="hidden" name="idTipoEditar" id="idTipoEditar">
                                                ...
                                                <div class="col-md-12 mt-3 text-center">
                                                    <a class="btn btn-sm btn-success  fw-bold btnAccion" id="btnRegistrarTipoDocumento" style="position: relative; width: 50%;">
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    cambiadeEstadoBotonYInput(
                        ...
                        'btnRegistrarTipoDocumento', // Nuevo ID para el botón
